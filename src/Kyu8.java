...
and then pulling one marble out. You get a point if you guessed correctly. The trick is you only have three seconds to make your guess,
...
public class Kyu8 {
    public static float guessBlue(int blueM, int redM, int blueMleft, int redMleft){
        if(redM-redMleft == 0){
            return 1.0F;
        }
        return (float) (blueM - blueMleft)/(redM-redMleft + blueM - blueMleft);
    }
}
